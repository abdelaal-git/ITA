...
create_clock {*}$port_args -name $clock_port -period 20

set input_delay_value [expr 20 * $::env(IO_DELAY_CONSTRAINT) / 100]
set output_delay_value [expr 20 * $::env(IO_DELAY_CONSTRAINT) / 100]
